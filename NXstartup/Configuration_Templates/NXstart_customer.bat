...
:: To enable this, copy the file in the NXstartup folder
:: the NXstart.bat file will call it after setting the
:: NXCUSTOM environment variables and generating
:: the standard report, before starting the application.

:: If you need the flexibility of a batch file before launching
:: NX, rename and edit this file. Avoid editing the NXstart.bat file.
